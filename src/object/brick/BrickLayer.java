...
import object.explosion.PendingExplosion;
                ...
                for (int i = 0; i < line.length(); i++) {
                    ...
                    switch (line.charAt(i)) {
                        ...
                        case '3':
                            ...
                            break;
                        case '4':
                            brick = new ExplosionBrick(GameConstants.BRICK_WIDTH * i, GameConstants.BRICK_HEIGHT * j + GameConstants.UI_TOP_BAR_HEIGHT);
                            break;
                        case '5':
                            brick = new Wall(GameConstants.BRICK_WIDTH * i, GameConstants.BRICK_HEIGHT * j + GameConstants.UI_TOP_BAR_HEIGHT);
                            wallCnt++;
                            break;
                        default:
                            break;
